...
import { ActionProducts } from './indexTypes';
import { ProductActionTypes } from '../actions/cartActionTypes';
import { ProductType, ProductDetailsType } from '../types/typeLibrary';

export type productListState = {
  loading: boolean;
  products: Array<ProductType> | undefined;
  productDetails?: Array<ProductDetailsType> | any;
}
...
export const productListReducer = ( state = productListInitialState, action: ActionProducts ) => {
...
//   loading: boolean;
//   products: Array<ProductDetailsType> 
// }

// export const productDetailsInitialState: productListState = {
//   loading: false,
//   products: [],
// }
