...
import { UserProfileType } from '../types/typeLibrary'
...
const UserEditScreen = () => {
  ...
  const { loading, error, user }: UserProfileType = userDetails
  ...
  if(user) {
    ...
    //let adminBoolean: string | undefined = user.isAdmin;
